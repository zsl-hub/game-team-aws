  ...
  "node_modules/ably/build/ably.js"(exports, module) {
    (function(g, f) {
      ...
      var _Logger = class _Logger2 {
        constructor() {
          _Logger2.logLevel = _Logger2.LOG_DEFAULT;
        }
        ...
        static logActionNoStrip(level, action, message) {
          if (_Logger2.shouldLog(level)) {
            (level === 1 ? _Logger2.logErrorHandler : _Logger2.logHandler)("Ably: " + action + ": " + message);
          }
        }
        static renamedClientOption(oldName, newName) {
          _Logger2.deprecationWarning(
        ...
        static deprecationWarning(message) {
          if (_Logger2.shouldLog(
            1
            /* Error */
          )) {
            _Logger2.logErrorHandler(`Ably: Deprecation warning - ${message}`);
          }
        }
      };
      _Logger.logLevel = 1;
